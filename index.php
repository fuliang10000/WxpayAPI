...
<body>
	<div align="center">
        <ul>
            ...
            <li style="background-color:#8B6914"><a href="http://120.79.184.17/WxpayAPI/example/native.php">扫码支付</a></li>
            <li style="background-color:#CDCD00"><a href="http://paysdk.weixin.qq.com/example/orderquery.php">订单查询</a></li>
            <li style="background-color:#CD3278"><a href="http://localhost/WxpayAPI/example/refund.php">订单退款</a></li>
